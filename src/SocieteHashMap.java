...
public class SocieteHashMap implements InterfaceSociete {
    ...
    public void afficherLesEmployesLeursDepartements() {
        ...
        for (Employee e : employeDepartementMap.keySet()) {
            System.out.println("Employe: " + e + ", Departement: " + employeDepartementMap.get(e));
        }
    ...
    public void afficherLesDepartements() {
        for (DEpartement d : employeDepartementMap.values()) {
            System.out.println(d);//retourne une collection de valeurs
        }
    }
    ...
    public boolean rechercherEmploye(Employee e) {
        return employeDepartementMap.containsKey(e);//hashcode et equals must be implemented in Employee and DEpartement
    }

    @Override
    public boolean rechercherDepartement(DEpartement d) {
        return employeDepartementMap.containsValue(d);//equals must be implemented in DEpartement
    }
